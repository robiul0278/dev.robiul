  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        >
          <span className="text-slate-300">MERN</span>
          <br />
        ...
        <p
          ref={subtitleRef}
          className="text-lg md:text-xl lg:text-2xl text-slate-300 mb-12 max-w-2xl mx-auto leading-relaxed"
        >
          Building modern, scalable web applications with MongoDB, Express, React, and Node.js. Clean code. Pixel-perfect UI. Blazing performance.
        </p>
        ...
        >
          <Button
            variant="outline"
            size="lg"
            className="glass border-white/20 text-white px-8 py-4 text-lg font-semibold rounded-full bg-transparent hover:bg-white/60 transition-all duration-300 cursor-pointer"
