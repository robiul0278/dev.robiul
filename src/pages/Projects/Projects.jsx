  ...
  return (
    <section className="relative">
      <div className="max-w-[1024px] mx-auto">
        ...
        <div className="">
          <span className="text-[#C778DD] text-[32px] font-semibold">{currentPath.charAt(0)}<span className=" text-white text-[28px] whitespace-nowrap">{currentPath.slice(1)}</span></span>
          <p className="tracking-wide pl-3">List of my projects</p>
        </div>

          <div className="flex items-center text-[32px] mt-10">
